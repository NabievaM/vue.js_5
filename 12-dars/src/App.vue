...
<template>
  <nav
    class="flex items-center justify-between py-5 px-2 bg-gray-700 h-20 shadow-lg mb-4"
  >
    <div>
      <baseSelect v-model="limitSize" @change="onLimitChange">
    ...
    <div>
      <baseButton class="me-1" @click="showAddModal = !showAddModal"
        >Add item</baseButton
      >
      <baseButton class="me-1" @click="showDeleteModal = !showDeleteModal"
  ...
  >
    <div class="text-right mb-6">
      <baseButton class="p-1 px-2 bg-red-700" @click="showUpdateModal = false"
        >X</baseButton
      >
    </div>
  ...
  <div
    v-if="showAddModal"
    class="absolute w-[50%] bg-gray-400 h-auto left-[20%] p-3"
  >
    <div class="text-right">
      <button class="p-1 px-2 bg-red-700" @click="showAddModal = false">
        X
      </button>
    </div>
      ...
      >
        ...
        <div class="cursor-pointer hover:shadow-md p-2 transition-shadow">
          ...
          <div class="flex justify-between">
            ...
            <baseButton
              @click="onShowUpdateModal(product)"
